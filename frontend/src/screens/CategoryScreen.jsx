...
const CategoryScreen = () => {
  return (
    <>
      <Helmet>
        <title>JMT-Creations | Shop</title>
        <meta
          name="description"
          content="Discover captivating digital prints. Elevate your spaces with modern artistry and timeless appeal. Explore our diverse collection, perfect for every style and taste"
        />
                  ...
                  <div className="cart-content">
                    ...
                    <div className="cart-text">
                      ...
                      <p className="cart-discription cart-desciption text-white">
                        Abstract paintings: They're vibrant portals to a
                        whimsical dimension, where untamed brushstrokes and bold
                        hues collide in a lively symphony.
                      </p>
                  ...
                  <div className="cart-content">
                    ...
                    <div className="cart-text">
                      ...
                      <p className="cart-discription cart-desciption text-white">
                        ...
                        characters, and boundless imagination. Pop Anime Art is
                        a captivating fusion of pop culture.
                      </p>
                      <h3 className=" fs-400 text-green cart-style">Slogan:</h3>
                      <p className="cart-slogan cart-slogan text-white">
                        Pop Anime Art: Where Colors Collide, Imagination
                        Thrives!
                      </p>
                    </div>
                    <div className="cart-cta">
