    ...
    <>
      <section className="spacer">
        <div className="hero-column spacer">
          ...
          <h2 className="ff-serif fs-500 text-green">
            Last updated August 01, 2023
          </h2>
          <h3 className="ff-serif text-brown">AGREEMENT TO OUR LEGAL TERMS</h3>
          <p>
            We are jmtrompcreations ("Company," "we," "us," "our"), a company
            registered in the Netherlands at __________, Meppel. We operate the
            website https://jmtrompcreations.com/ (the "Site"), as well as any
            other related products and services that refer or link to these
            legal terms (the "Legal Terms") (collectively, the "Services"). I
            provide services in webdesign and deployment for B2C. And for fun
            projects downloadables You can contact us by email at
            jmtromp@jmtrompcreations.com or by mail to __________, Meppel,
            Netherlands. These Legal Terms constitute a legally binding
            agreement made between you, whether personally or on behalf of an
            entity ("you"), and jmtrompcreations, concerning your access to and
            ...
            Terms to stay informed of updates. You will be subject to, and will
          ...
          <h4 className="ff-serif text-brown"> TABLE OF CONTENTS</h4>
          <ul>
          ...
          <h4 className="ff-serif text-brown"> 1. OUR SERVICES</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">
          ...
          <p>
            ...
            <span className="text-brown">jmtromp@jmtrompcreations.com.</span> If
          ...
          will terminate immediately. Your submissions Please review this
          ...
          compensation to you. You are responsible for what you post or upload:
          ...
          applicable law.
          <h4 className="ff-serif text-brown">3. USER REPRESENTATIONS</h4>
          <p>
          ...
          <p>
            ...
            be in Euros. You agree to pay all charges at the prices then in
          ...
          <h4 className="ff-serif text-brown">6. REFUNDS POLICY</h4>
          <p> All sales are final and no refund will be issued.</p>
          <h4 className="ff-serif text-brown">7. PROHIBITED ACTIVITIES</h4>
          <p>
            {" "}
          ...
          <p>
            ...
            Services and/or the Content contained therein. Disparage, tarnish,
            ...
            harm another person. Make improper use of our support services or
            submit false reports of abuse or misconduct. Use the Services in a
            manner inconsistent with any applicable laws or regulations. Engage
            in unauthorized framing of or linking to the Services. Upload or
            ...
            or commercial enterprise. Use the Services to advertise or offer to
          ...
          <p>
            ...
            any Contributions, you thereby represent and warrant that: The
          ...
          <h4 className="ff-serif text-brown">9. CONTRIBUTION LICENSE</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">10. GUIDELINES FOR REVIEWS</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">12. SERVICES MANAGEMENT</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">13. PRIVACY POLICY</h4>
          <p>
            We care about data privacy and security. Please review our Privacy
            Policy:{" "}
            <span className="ff-serif text-brown">
              https://jmtrompcreations.com/service.html
            </span>
            ...
            that differ from applicable laws in the Netherlands, then through
            your continued use of the Services, you are transferring your data
            to the Netherlands, and you expressly consent to have your data
            transferred to and processed in the Netherlands. Further, we do not
          ...
          <h4 className="ff-serif text-brown">14. TERM AND TERMINATION</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">16. GOVERNING LAW</h4>
          <p>
            These Legal Terms are governed by and interpreted following the laws
            of the Netherlands, and the use of the United Nations Convention of
            ...
            jmtrompcreations and yourself both agree to submit to the
            non-exclusive jurisdiction of the courts of Drenthe, which means
            that you may make a claim to defend your consumer protection rights
            in regards to these Legal Terms in the Netherlands , or in the EU
            country in which you reside.
          </p>
          <h4 className="ff-serif text-brown">17. DISPUTE RESOLUTION</h4>
          <p>
            Informal Negotiations To expedite resolution and control the cost of
            any dispute, controversy, or claim related to these Legal Terms
            ...
            Meppel, Netherlands. The language of the proceedings shall be Dutch.
            Applicable rules of substantive law shall be the law of the
            Netherlands. Restrictions The Parties agree that any arbitration
            ...
            any Dispute to be arbitrated on a className-action basis or to
            utilize className action procedures; and (c) there is no right or
            ...
            persons. Exceptions to Informal Negotiations and Arbitration The
          ...
          <h4 className="ff-serif text-brown">18. CORRECTIONS</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">19. DISCLAIMER</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">20. LIMITATIONS OF LIABILITY</h4>
          <p>
            ...
            US OR $10.00 USD. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS DO
          ...
          <h4 className="ff-serif text-brown">21. INDEMNIFICATION</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">22. USER DATA</h4>
          <p>
          ...
          <h4 className="ff-serif text-brown">25. MISCELLANEOUS</h4>
          <p>
            {" "}
          ...
          <h4 className="ff-serif text-brown">26. CONTACT US</h4>
          <p>
          ...
          <ul>
            <li>jmtrompcreations</li>
            <li>Meppel</li>
            <li>Netherlands</li>
            <li className="text-brown">jmtromp@jmtrompcreations.com</li>
            <li>Last updated May 17, 2023</li>
          </ul>
          <h4 className="ff-serif text-brown">AGREEMENT TO OUR LEGAL TERMS</h4>
          <p>
            I as jmtrompcreations ("Company," "we," "us," "our"), a company
            registered in the Netherlands at __________, Meppel.
          </p>
          <p>
            {" "}
            We operate the website{" "}
            <span className="text-brown">
              https://jmtrompcreations.com/{" "}
            </span>{" "}
          ...
          <p>
            I provide services in webdesign and deployment for B2C. And for fun
            projects downloadables
          </p>
          <p>
            You can contact us by email at{" "}
            <span className="text-brown">jmtromp@jmtrompcreations.com</span> -
            Meppel, Netherlands.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and jmtrompcreations, concerning your access to and use of the
